...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    `},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.mb_invert={value:t.map.flipY?G.invert:!G.invert},e.uniforms.mb_offsetA={value:new THREE.Vector2(G.offsetAX+Math.random(),G.offsetAY+Math.random())},e.uniforms.mb_offsetB={value:new THREE.Vector2(G.offsetBX+Math.random(),G.offsetBY+Math.random())}},updateUniforms:function(e,t){t.uniforms.mb_time.value=.001*e}};const $=String.raw,Z=Object.assign({},E,{iChannel0:{value:null},iChannel1:{value:null}}),J=new THREE.TextureLoader;var K,Q;J.load(A,(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,K=e})),J.load("https://hartswf0.github.io/core-components/1ec965c5d6df577c.jpg",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Q=e}));let ee={uniforms:Z,vertexShader:{},fragmentShader:{uniforms:w+$`
        ...
        `,replaceMap:y},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.uniforms.iChannel0.value=K,e.uniforms.iChannel1.value=Q,e.userData.timeOffset=1e4*(Math.random()+.5)},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e+t.userData.timeOffset,t.uniforms.iChannel0.value=K,t.uniforms.iChannel1.value=Q}};var te="https://hartswf0.github.io/core-components/481a92b44e56dad4.png";const ie=String.raw,ae={warpTime:{value:0},warpTex:{value:null},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0}};var oe;(new THREE.TextureLoader).load(te,(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,oe=e}));let re={uniforms:ae,vertexShader:{},fragmentShader:{uniforms:ie`
